...
mode = '2k';
%% code lyer
numMPEG2 = 2000;  % number of MPEG2 TS 8*188 Packets to Energy Dispersal
fid = fopen('test.ts','r');
...
%         OFDMSymbol = resample(OFDMSymbol,10,1);
%         OFDMSymbol = resample(OFDMSymbol,1,10);
%         OFDMSymbol_10MHz = resample(OFDMSymbol,70,64);
